var authorization = "Bearer Bearer AAAAAAAAAAAAAAAAAAAAANRILgAAAAAAnNwIzUejRCOuH5E6I8xnZz4puTs%3D1Zv7ttfk8LF81IUq16cHjhLTvJu4FA33AGWWjCpTnA
"; // replace by authorization value
var ua = navigator.userAgentData.brands.map(brand => `"${brand.brand}";v="${brand.version}"`).join(', ');
var client_tid = "Tx1pTp/JIJtVu2u5JrC36JDwa3d+Nwo+j1QF81f5WKwB+k24+Mvap/aoebct1MUtZqXAp0sf9xukLBRlLnY+2X7Tw0ZpTA"; // replace by X-Client-Transaction-Id value
var client_uuid = "8bfXX854-XXXX-4a1c-84e7-XXXXXXXXXXX"; // replace by X-Client-Uuid value
...
var username = "mediagag" // replace with your username
